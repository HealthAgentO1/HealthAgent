...
const LOGO_SRC: Record<Exclude<InsuranceLogoId, 'other'>, string> = {
  ...
  fidelis: assetUrl('insurance-logos/fidelis.png'),
  ...
  bluecross: assetUrl('insurance-logos/bluecross.png'),
  aetna: assetUrl('insurance-logos/aetna.svg'),
};
